package dev.menezes.mastersys.doc;
...
public interface AlunoControllerDoc {
    ...
    @Operation(
            ...
            description = "Cria um novo aluno no sistema da academia",
            responses = {
                    @ApiResponse(
                            responseCode = "201",
    ...
    @Operation(
            ...
            description = "Lista alunos de forma paginada, permitindo filtros opcionais por nome, e-mail, celular, cidade e estado",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
    ...
    @Operation(
            ...
            description = "Atualiza os dados de um aluno já cadastrado",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
