package dev.menezes.mastersys.dto;
...
public record AlunoRequest(
        ...
        @Size(max = 1, message = "O sexo deve ter no maáximo 1 caractere.")
        String sexo,
        ...
        @Size(max = 2, message = "O estado deve ter no máximo 02 caracteres.")
        String estado,
